<?php
class ModelReportBooking extends Model {
	// Sales
	...
	// Map
	public function getTotalBookingsByCountry() {
		$sql = "select COUNT(*) AS total,sum(book.BkCubM) as amount,country.CntyISO as iso_code_2 from lcl_book as book
		inner join troy_destads as dest on book.BkDest = dest.destcode
		inner join troy_cntyads as country on country.cntycode = dest.destcnty 
		where bkstat ='O' group by country.cntycode"
