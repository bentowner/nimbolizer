<?php
class ModelMaintenanceCustomer extends Model {
	...
	public function getCustomer($customer_id) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX_APP . "cust WHERE CustCode = '" . $customer_id . "'");
	...
	public function getTotalCustomers($data = array()) {
		...
		if (!empty($data['filter_date_added'])) {
			$implode[] = "custstrt = DATE('" . $this->db->escape($data['filter_date_added']) . "')";
		}

		if (!empty($data['filter_since_date_added'])) {
			$implode[] = "custstrt > DATE('" . $this->db->escape($data['filter_since_date_added']) . "')";
		}
		
		if (!empty($data['filter_date_modified'])) {
			$implode[] = "custstrt > DATE('" . $this->db->escape($data['filter_date_modified']) . "')";
		}
