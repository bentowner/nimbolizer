...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_booking_status'] = $this->language->get('entry_booking_status');
		$data['entry_booking_status_intransit'] = $this->language->get('entry_booking_status_intransit');
		$data['entry_booking_status_used'] = $this->language->get('entry_booking_status_used');
		...
		$this->session->data['booking_statuses']= $data['booking_statuses'] = $this->model_localisation_order_status->getBookingStatuses();
		$this->session->data['booking_statuses_OS']=$this->cache->get('booking_status.' . (int)$this->config->get('config_language_id'));
