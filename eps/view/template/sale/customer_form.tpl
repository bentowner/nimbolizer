...
<div id="content">
      ...
      <div class="panel-body">
       ...
       <?php } else { ?>    
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <select name="customer_group_id" id="input-customer-group" class="form-control">
                            ...
                            <option value="<?php echo $customer_group['custcode']; ?>" selected="selected"><?php echo $customer_group['name']; ?></option>
                            <?php } else { ?>
                            <option value="<?php echo $customer_group['custcode']; ?>"><?php echo $customer_group['name']; ?></option>
                            <?php } ?>
                            <?php } ?>
                          </select>
                        </div>
          ...
          <?php } ?>      
                      ...
                      <div id="company" style="display:none;" class="form-group required">
                        <label class="col-sm-2 control-label" for="input-company"><?php echo $entry_company ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control" />
                          <?php if ($error_company) { ?>
                          <div class="text-danger"><?php echo $error_agent; ?></div>
                          <?php  } ?>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="shipper"><?php echo $entry_shipper; ?></label>
                        <div class="col-sm-10">
                          <input type="checkbox" name="shipper" value="<?php echo $shipper; ?>" id="shipper" class="form-control" />
                        </div>
                      </div>
                  
                      <div id="agent" style="display:none;" class="form-group required">
                        <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_agent ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="agent" value="<?php echo $agent; ?>" placeholder="<?php echo $entry_agent; ?>" id="input-agent" class="form-control" />
                          <input type="hidden" name="customer_agent_id" value="<?php echo $customer_agent_id; ?>" id="input-customer_agent_id" class="form-control" />
 ...
 <script type="text/javascript"><!--
 		$(document).ready(function() {
 			 if($('#shipper').val()== "true"){           
 		         $('#shipper:checkbox').prop('checked',true);
 		    }else{
 		        $('#shipper:checkbox').prop('checked', false);
 		    }
  		    
 			display();
 		});
 
		$("input[name=shipper]").change(function(){
		var shipper =$("#shipper").is(':checked') ? true : false;
		display();
		$.post('controller/setting/ajaxpersist.php', { 'fieldname' : 'shipper', 'value':shipper});
		});	

		function display(){
			var shipper =$("#shipper").is(':checked') ? true : false;
			var company =$("#shipper").is(':checked') ? true : false;
			
			if (shipper){document.getElementById("agent").style.display = "";} else{
				document.getElementById("agent").style.display = "none";
				}
			if (company){document.getElementById("company").style.display = "";} else{
				document.getElementById("company").style.display = "none";
				}
		}

		var url_agent='index.php?route=sale/customer/getAgentList&token=<?php echo $token; ?>&custcode=<?php echo $custcode; ?>&filter_name=';
		
		$('input[name=\'agent\']').autocomplete({
			
			'source': function(request, response) {
				$.ajax({url: url_agent +  encodeURIComponent(request),
						dataType: 'json',
						success: function(json) {
							response($.map(json, function(item) {
								return {
									...
									value2: item['firstname'] +' ' + item['lastname']
			...
			'select': function(item) {
				$('input[name=\'agent\']').val(item['value2']);
				$('input[name=\'customer_agent_id\']').val(item['value']); 
