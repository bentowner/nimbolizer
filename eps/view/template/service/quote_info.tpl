  ...
  <td style="padding-left: 1cm ;text-align: left;"><label class="radio" onclick = "document.location.href='index.php?route=service/booking/updateFreightForwarder&token=<?php echo $token; ?>'"  onchange="showHide();displayBrokerage();"> <input type="radio" id="Bkcold" name="Bkcold" value="F" checked="checked"> <?php echo $entry_forward; ?></label></td>
   ...
   <?php } else { ?>
		 ...
		 <table class="" >		
            ...
            <tr><td><label>
    <?php if ($pickup == "true") { ?>
			  <input type="checkbox" id="pickup" name="pickup" checked="checked"  onclick = "document.location.href='index.php?route=service/quotations/clearTrucking&token=<?php echo $token; ?>'" onchange="showHide()" > <?php echo $entry_pickup; ?>
	<?php } else { ?>
	<input type="checkbox" id="pickup" name= "pickup"  onclick = "document.location.href='index.php?route=service/quotations/clearTrucking&token=<?php echo $token; ?>'" onchange="showHide()" > <?php echo $entry_pickup; ?>
	<?php } ?>
			  </label>
			  </td>
    ...
    <tr><td><label>
	 ...
	 <?php } ?>
      ...
      <?php if ($hazardous  == "true") { ?>	
	         <tr> 
			  <td><label>
			  <input type="checkbox" id = "hazardous" name="hazardous" value="" checked="checked"  onchange="self.location=self.location;showHide();"> <?php echo $entry_hazardous; ?>
              </label></td>
             </tr>
               <tbody >
			<tr>
             <tr>
		<div style="border: 1px solid #c0dcc0;">
      ...
      <?php } else { ?>
              <tr> 
			  <td><label>
              <input type="checkbox"  id = "hazardous" name="hazardous" value=""  onchange="self.location=self.location;showHide();"> <?php echo $entry_hazardous; ?>
               </label></td>
             </tr>	  
...
<!--- // Rates calc or entered // --->            
            ...
            <tr>
              ...
              <td><input disabled = "disabled" class="txt form-control" type="text" onblur="calcTotal(this, 'tot')" placeholder="$0.00"  name="rates_precarriage_amount"  value="<?php echo $rates_precarriage_amount; ?>"/></td>
            </tr>
            <?php }else ?>
            ...
            <?php if ($destdocs=='true' && $rates_destdocs >'0.00') { ?>
            <tr>
    ...
    <div class="tracking_log"><div class=".col-lg-12 col-md-12 col-sm-12"><?php echo $tracking_details; ?></div></div><!--"tracking-content" -->   		
	</div><!-- end tab content-->
...
<script type="text/javascript"><!--
	...
	$(document).on("click", ".contact", function(e) {
		...
		var url= 'index.php?route=sale/customer/add&token=<?php echo $token; ?>&customer_group_id=';	
			
		bootbox.dialog({
			message: contact,
			title: "View Customer Contacts",
...
$("input[name=rates_destdocs]").live('change',function() {
...
$("input[name=rates_customsclearance]").live('change',function() {
...
<script type="text/javascript">$(document).ready(function() {var rates_hazardous = $("input[name=rates_hazardous]").val();
	...
	$("input[name=rates_hazardous]").live('change',function(){
	...
	$("input[name=rates_hazardous_min]").live('change',function(){
		var rates_hazardous = $("#rates_hazardous").val();	
		var rates_hazardous_min = $("input[name=rates_hazardous_min]").val();	
		var rates_hazardous_min2 = parseFloat(rates_hazardous_min);		
...
<script type="text/javascript">$(document).ready(function() {var rates_other2 = $("input[name=rates_other2]").val();
	...
	$("input[name=rates_other2]").live('change',function(){	
...
<script type="text/javascript">$("input[name=Bkhtsr]").live('change',function(){	
	var Bkhtsr = $("#Bkhtsr").val();	
	$.post('controller/setting/ajaxpersist.php', {'fieldname' : 'Bkhtsr','value':Bkhtsr} );
	$('input[name=\'Bkhtsr\']').val(Bkhtsr);	
	
	});	</script>
<script type="text/javascript">$("input[name=BkHtsm]").live('change',function(){	
...
<script type="text/javascript">$("input[name=rates_other4]").live('change',function(){var rates_other4 = $("#rates_other4").val();
